...
export default function SignInGate() {
  ...
  return (
    <div className="signin-overlay" id="signinOverlay">
      <div className="signin-card">
        ...
        {error && <p id="signinError" className="signin-error">{error}</p>}
        <p className="signin-hint">💡 第一次使用：登录后会自动创建你们的共享空间。两个人各自登录后，所有改动都会实时同步。</p>
      </div>
    </div>
  );
}
